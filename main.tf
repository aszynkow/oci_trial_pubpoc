...
Bgl_Oci_Cor_Shr_Syd_Drgs = [for x in data.oci_core_drgs.bgl_drgs.drgs: x if x.display_name == var.Bgl_Oci_Cor_Shr_Syd_Drg_01_display_name]
Bgl_Oci_Cor_Shr_Syd_Drg_01_id = local.Bgl_Oci_Cor_Shr_Syd_Drgs.0.id
